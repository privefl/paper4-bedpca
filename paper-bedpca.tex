...
\subsection{Subsetted version of 1000G data [RENAME?]}
...
\item projecting computed PCs to the target data using an optimised implementation of the Online Augmentation, Decomposition, and Procrustes (OADP) transformation \cite[]{zhang2019fast} described in Supplementary Materials.
\end{enumerate}
...
[CAN COMPUTE SVD OF $V'[1{:}K,~]$ FROM LOW-RANK UPDATE?]
