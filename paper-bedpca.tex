...
\noindent[TODO SECTION ON HOMOGENEOUS SAMPLES / COMPARE WITH ABERRANT]
...
To restrict to homogeneous samples, we compare the use of R package aberrant used to report the ``White British'' subset of UKBB homogeneous samples, to the use of the robust Mahalanobis distance we propose.
...
In contrast, 416,492 out of 431,090 ``British'' (96.6\%) and 12,620 out of 12759 ``Irish'' (98.9\%) are kept.
