...
[SHOULD ALSO TALK ABOUT PCADAPT AND LD]
...
Then, we computed again PCA after restricting the individuals included in the computations: we randomly subsampled UKBB data to use only 10,000 British individuals (out of 431,029) and to 5000 Irish individuals (out of 12,755), while keeping all individuals with other self-reported individuals. 
We further removed all individuals for all pairs of related individuals reported by the UKBB. 
This resulted in 48,942 individuals that we used to compute 50 PCs in less than 3 hours using function \texttt{bed\_autoSVD}. 
...
As competing interest, you can write
Michael Blum is an employee at OWKIN.
