...
It takes 22 minutes to perform a first phase of clumping on 488,371 individuals genotyped over 504,139 variants, which reduces the number of variants to 261,307. It then takes 34 minutes to compute the first 20 PCs using these 261,307 variants.
